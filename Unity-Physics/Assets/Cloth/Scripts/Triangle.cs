            ...
            foreach (var collider in Particle.gos)
            {
                ...
                if (sp)
                {
                    ...
                    if (Vector3.Distance(p1.position, sp.transform.position) < Vector3.Distance((p2.position + p3.position) / 2f, p1.position) + sp.radius * sp.transform.localScale.x +.1f&& Vector3.Distance(p2.position, sp.transform.position) < Vector3.Distance((p1.position + p3.position) / 2f, p2.position) + sp.radius * sp.transform.localScale.x + .1f && Vector3.Distance(p3.position, sp.transform.position) < Vector3.Distance((p1.position + p2.position) / 2f, p3.position) + sp.radius * sp.transform.localScale.x + .1f)
                    {
                        ...
                        p1.AddForce((p1.position - sp.transform.position).normalized * avgVelo.magnitude * 4f * (-(5*Vector3.Distance(p1.position,sp.transform.position)-Mathf.Pow(sp.transform.localScale.x,2)-sp.transform.localScale.x)+ sp.transform.localScale.x));
                        p2.AddForce((p1.position - sp.transform.position).normalized * avgVelo.magnitude * 4f * (-(5*Vector3.Distance(p2.position,sp.transform.position)-Mathf.Pow(sp.transform.localScale.x,2)-sp.transform.localScale.x)+ sp.transform.localScale.x));
                        p3.AddForce((p1.position - sp.transform.position).normalized * avgVelo.magnitude * 4f * (-(5*Vector3.Distance(p3.position,sp.transform.position)-Mathf.Pow(sp.transform.localScale.x,2)-sp.transform.localScale.x)+ sp.transform.localScale.x));
                    }
